...
module Electron =
    ...
    type [<AllowNullLiteral>] App =
        ...
        [<Emit "$0.on('session-created',$1)">] abstract ``on_session-created``: listener: (Event -> Session -> unit) -> App
        [<Emit "$0.once('session-created',$1)">] abstract ``once_session-created``: listener: (Event -> Session -> unit) -> App
        [<Emit "$0.addListener('session-created',$1)">] abstract ``addListener_session-created``: listener: (Event -> Session -> unit) -> App
        [<Emit "$0.removeListener('session-created',$1)">] abstract ``removeListener_session-created``: listener: (Event -> Session -> unit) -> App
        ...
        abstract whenReady: unit -> Promise<obj option>
        ...
        abstract isPackaged: bool option with get, set
    ...
    type [<AllowNullLiteral>] BrowserWindow =
        ...
        abstract loadFile: filePath: string -> unit
    ...
    type [<AllowNullLiteral>] Dialog =
        ...
        abstract showOpenDialog: browserWindow: BrowserWindow * options: OpenDialogOptions * ?callback: (ResizeArray<string> -> ResizeArray<string> -> unit) -> ResizeArray<string>
        /// The browserWindow argument allows the dialog to attach itself to a parent
        /// window, making it modal. The filters specifies an array of file types that can
        /// be displayed or selected when you want to limit the user to a specific type. For
        /// example: The extensions array should contain extensions without wildcards or
        ...
        /// file selector and a directory selector, so if you set properties to ['openFile',
        /// 'openDirectory'] on these platforms, a directory selector will be shown.
        abstract showOpenDialog: options: OpenDialogOptions * ?callback: (ResizeArray<string> -> ResizeArray<string> -> unit) -> ResizeArray<string>
        /// The browserWindow argument allows the dialog to attach itself to a parent
        /// window, making it modal. The filters specifies an array of file types that can
        ...
        /// callback(filename).
        abstract showSaveDialog: browserWindow: BrowserWindow * options: SaveDialogOptions * ?callback: (string -> string -> unit) -> string
        /// The browserWindow argument allows the dialog to attach itself to a parent
        /// window, making it modal. The filters specifies an array of file types that can
        /// be displayed, see dialog.showOpenDialog for an example. If a callback is passed,
        /// the API call will be asynchronous and the result will be passed via
        /// callback(filename).
        abstract showSaveDialog: options: SaveDialogOptions * ?callback: (string -> string -> unit) -> string
    ...
    type [<AllowNullLiteral>] DownloadItem =
        ...
        [<Emit "$0.on('done',$1)">] abstract on_done: listener: (Event -> U3<string, string, string> -> unit) -> DownloadItem
        [<Emit "$0.once('done',$1)">] abstract once_done: listener: (Event -> U3<string, string, string> -> unit) -> DownloadItem
        [<Emit "$0.addListener('done',$1)">] abstract addListener_done: listener: (Event -> U3<string, string, string> -> unit) -> DownloadItem
        [<Emit "$0.removeListener('done',$1)">] abstract removeListener_done: listener: (Event -> U3<string, string, string> -> unit) -> DownloadItem
        /// Emitted when the download has been updated and is not done. The state can be one
        /// of following:
        [<Emit "$0.on('updated',$1)">] abstract on_updated: listener: (Event -> U2<string, string> -> unit) -> DownloadItem
        [<Emit "$0.once('updated',$1)">] abstract once_updated: listener: (Event -> U2<string, string> -> unit) -> DownloadItem
        [<Emit "$0.addListener('updated',$1)">] abstract addListener_updated: listener: (Event -> U2<string, string> -> unit) -> DownloadItem
        [<Emit "$0.removeListener('updated',$1)">] abstract removeListener_updated: listener: (Event -> U2<string, string> -> unit) -> DownloadItem
    ...
    type [<AllowNullLiteral>] InAppPurchase =
        ...
        [<Emit "$0.on('transactions-updated',$1)">] abstract ``on_transactions-updated``: listener: (Event -> ResizeArray<Transaction> -> unit) -> InAppPurchase
        [<Emit "$0.once('transactions-updated',$1)">] abstract ``once_transactions-updated``: listener: (Event -> ResizeArray<Transaction> -> unit) -> InAppPurchase
        [<Emit "$0.addListener('transactions-updated',$1)">] abstract ``addListener_transactions-updated``: listener: (Event -> ResizeArray<Transaction> -> unit) -> InAppPurchase
        [<Emit "$0.removeListener('transactions-updated',$1)">] abstract ``removeListener_transactions-updated``: listener: (Event -> ResizeArray<Transaction> -> unit) -> InAppPurchase
        ...
        abstract getProducts: productIDs: ResizeArray<string> * callback: (ResizeArray<Product> -> unit) -> unit
        ...
        abstract purchaseProduct: productID: string * ?quantity: float * ?callback: (bool -> unit) -> unit
    ...
    type [<AllowNullLiteral>] NetLog =
        ...
        abstract currentlyLogging: bool option with get, set
    ...
    type [<AllowNullLiteral>] Protocol =
        ...
        /// protocol handler.
        abstract interceptStreamProtocol: scheme: string * handler: (InterceptStreamProtocolRequest -> (U2<Node.Stream.Readable<Node.Buffer.Buffer>, StreamProtocolResponse> -> unit) -> unit) * ?completion: (Error -> unit) -> unit
        /// Intercepts scheme protocol and uses handler as the protocol's new handler which
        ...
        abstract registerStreamProtocol: scheme: string * handler: (RegisterStreamProtocolRequest -> (U2<Node.Stream.Readable<Node.Buffer.Buffer>, StreamProtocolResponse> -> unit) -> unit) * ?completion: (Error -> unit) -> unit
    ...
    type [<AllowNullLiteral>] Referrer =
        ...
        abstract policy: U8<string, string, string, string, string, string, string, string> with get, set
        /// HTTP Referrer URL.
    ...
    type [<AllowNullLiteral>] StreamProtocolResponse =
        ...
        abstract data: Node.Stream.Readable<Node.Buffer.Buffer> with get, set
    ...
    type [<AllowNullLiteral>] SystemPreferences =
        ...
        abstract subscribeWorkspaceNotification: ``event``: string * callback: (string -> obj option -> unit) -> unit
    ...
    type [<AllowNullLiteral>] Transaction =
        ...
        /// deferred.
        abstract transactionState: U5<string, string, string, string, string> with get, set
    ...
    type [<AllowNullLiteral>] WebContents =
        ...
        [<Emit "$0.on('did-start-navigation',$1)">] abstract ``on_did-start-navigation``: listener: (string -> bool -> bool -> float -> float -> unit) -> WebContents
        [<Emit "$0.once('did-start-navigation',$1)">] abstract ``once_did-start-navigation``: listener: (string -> bool -> bool -> float -> float -> unit) -> WebContents
        [<Emit "$0.addListener('did-start-navigation',$1)">] abstract ``addListener_did-start-navigation``: listener: (string -> bool -> bool -> float -> float -> unit) -> WebContents
        [<Emit "$0.removeListener('did-start-navigation',$1)">] abstract ``removeListener_did-start-navigation``: listener: (string -> bool -> bool -> float -> float -> unit) -> WebContents
        ...
        /// example:
        [<Emit "$0.on('new-window',$1)">] abstract ``on_new-window``: listener: (Event -> string -> string -> U6<string, string, string, string, string, string> -> obj option -> ResizeArray<string> -> Referrer -> unit) -> WebContents
        [<Emit "$0.once('new-window',$1)">] abstract ``once_new-window``: listener: (Event -> string -> string -> U6<string, string, string, string, string, string> -> obj option -> ResizeArray<string> -> Referrer -> unit) -> WebContents
        [<Emit "$0.addListener('new-window',$1)">] abstract ``addListener_new-window``: listener: (Event -> string -> string -> U6<string, string, string, string, string, string> -> obj option -> ResizeArray<string> -> Referrer -> unit) -> WebContents
        [<Emit "$0.removeListener('new-window',$1)">] abstract ``removeListener_new-window``: listener: (Event -> string -> string -> U6<string, string, string, string, string, string> -> obj option -> ResizeArray<string> -> Referrer -> unit) -> WebContents
    ...
    type [<AllowNullLiteral>] WebFrame =
        ...
        abstract executeJavaScriptInIsolatedWorld: worldId: float * scripts: ResizeArray<WebSource> * ?userGesture: bool * ?callback: (obj option -> unit) -> unit
        ...
        abstract setIsolatedWorldContentSecurityPolicy: worldId: float * csp: string -> unit
        /// Set the name of the isolated world. Useful in devtools.
        abstract setIsolatedWorldHumanReadableName: worldId: float * name: string -> unit
        /// Set the security origin of the isolated world.
        abstract setIsolatedWorldSecurityOrigin: worldId: float * securityOrigin: string -> unit
        /// Sets the maximum and minimum layout-based (i.e. non-visual) zoom level.
        abstract setLayoutZoomLevelLimits: minimumLevel: float * maximumLevel: float -> unit
        ...
        /// the same routingId.
        abstract routingId: float option with get, set
    ...
    type [<AllowNullLiteral>] BrowserWindowConstructorOptions =
        ...
        abstract titleBarStyle: U4<string, string, string, string> option with get, set
    ...
    type [<AllowNullLiteral>] PermissionRequestHandlerDetails =
